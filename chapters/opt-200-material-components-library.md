...
> For example: Replace your plain shopping cart table with [Material Table](https://material.angular.io/components/table/overview) and your plain buttons with [Material Buttons](https://material.angular.io/components/button/overview)
