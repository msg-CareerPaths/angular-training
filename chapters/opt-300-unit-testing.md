...
> - One of your components ([DOM test](https://angular.dev/guide/testing/components-scenarios), preferably for the product detail page - check that the title and description are present on the component as expected).
